...
pub mod shortint_utils {
    ...
    #[cfg(not(feature = "gpu"))]
    use tfhe::shortint::parameters::current_params::V1_0_PARAM_MULTI_BIT_GROUP_4_MESSAGE_2_CARRY_2_KS_PBS_GAUSSIAN_2M128;
    ...
    impl Default for ParamsAndNumBlocksIter {
        fn default() -> Self {
            ...
            if env_config.is_multi_bit {
                ...
                #[cfg(not(feature = "gpu"))]
                let params = vec![
                    V1_0_PARAM_MULTI_BIT_GROUP_4_MESSAGE_2_CARRY_2_KS_PBS_GAUSSIAN_2M128.into(),
                ];
