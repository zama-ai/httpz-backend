...
contract FHEGasLimit is UUPSUpgradeable, Ownable2StepUpgradeable {
    ...
    function payForFheAdd(FheType resultType, bytes1 scalarByte) external virtual {
        ...
        _checkIfNewBlock();
        if (scalarByte == 0x01) {
            if (resultType == FheType.Euint8) {
                _updateFunding(94000);
            } else if (resultType == FheType.Euint16) {
                _updateFunding(133000);
            } else if (resultType == FheType.Euint32) {
                _updateFunding(162000);
            } else if (resultType == FheType.Euint64) {
                _updateFunding(188000);
            } else if (resultType == FheType.Euint128) {
    ...
    function payForFheBitAnd(FheType resultType, bytes1 scalarByte) external virtual {
        ...
        _checkIfNewBlock();
        if (scalarByte == 0x01) {
            if (resultType == FheType.Ebool) {
                _updateFunding(26000);
            } else if (resultType == FheType.Euint8) {
            ...
            } else if (resultType == FheType.Euint256) {
    ...
    function payForFheEq(FheType resultType, bytes1 scalarByte) external virtual {
        ...
        if (scalarByte == 0x01) {
            ...
            } else if (resultType == FheType.Euint160) {
                _updateFunding(90000);
            } else if (resultType == FheType.Euint256) {
                _updateFunding(100000);
            } else if (resultType == FheType.Ebytes64) {
                _updateFunding(150000);
            } else if (resultType == FheType.Ebytes128) {
                _updateFunding(200000);
            } else if (resultType == FheType.Ebytes256) {
